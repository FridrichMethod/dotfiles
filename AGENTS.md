...
- Keep all three AI sync helpers fail-closed. Update their sources, README documentation, and focused tests together when shared config, permission, or rule behavior changes.
