...
| `scripts/awesome-skills-update.sh` | `awesome-skills-update.sh` | nounset/session/disable guards, first sync, download/installer failures, success stamp, throttle, live/stale PID locks, missing curl, cleanup |
